...
class JournalViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var prayerCategoryHeaders = ["Personal","Julie","Our Marriage"]
    var prayersByCategory: [Int: [String]] = [:]
    var swipeRight = UISwipeGestureRecognizer()
    var prayer1 = ["Lorem ipsum dolor sit er elit lamet, consectetaur cillium adipisicing pecu, sed do eiusmod tempor incididunt ut labore ","Last prayed 3 days ago","Prayed 5 times"]
    var prayer2 = ["Lorem ipsum dolor sit er elit lamet, consectetaur cillium adipisicing pecu, sed do eiusmod tempor incididunt ut labore Lorem ipsum dolor sit er elit lamet, consectetaur cillium adipisicing pecu, sed do eiusmod tempor incididunt ut labore ","Last prayed 1 day ago","Prayed 4 times"]
    var prayer3 = ["Lorem ipsum dolor sit er elit lamet, consectetaur cillium adipisicing pecu, sed do eiusmod tempor incididunt ut labore ","Last prayed 1 week ago","prayed 5 times"]
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        return  prayerCategoryHeaders.count
    }
